...
//var meetupApiUrl = 'http://api.meetup.com/2/open_events?status=upcoming&radius=5&category=34&and_text=False&limited_events=False&text=coding+programming+ruby+python+javascript+html&desc=False&offset=0&photo-host=public&format=json&lat=45.528114&page=100&lon=-122.689798&sig_id=178346822&sig=1a186723262b63d4b2deee474b8d95bc0ec2ec9f';

// var fourSquareApiUrl = 'https://foursquare.com/explore?mode=url&near=portland&q=beer'

var fourSquareApiUrl = 'https://foursquare.com/explore?mode=url&near=Portland%2C%20OR&nearGeoId=72057594043674481&q=beer'
 ...
 */
var Spots = function(venueObject, map) {
  var self = this;
...
var GoogleMap = function(center, element) {
  ...
  var mapOptions = {
    ...
    mapTypeControlOptions: {
      mapTypeIds: [google.maps.MapTypeId.ROADMAP, 'ShadesOfGrey']
    },
  ...
  var usRoadMapType = new google.maps.StyledMapType(ShadesOfGrey, styledMapOptions);
...
var AppViewModel = function() {
  ...
  var map,
      ...
      center = new google.maps.LatLng(45.52089644, -122.6857073); // Portland, Oregon
  ...
  self.filteredSpotList = ko.computed(function() {
  ...
  function fetchSpots(url) {
    ...
    // if failed
      ...
      $('#search-summary').text('FourSquare data could not load...');
    });
  }
